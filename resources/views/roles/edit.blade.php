<x-layouts.app>
    {{-- 
      Struktur disederhanakan dan kelas untuk background/panel diterapkan di sini.
      Tag <section> dan <div> digabung menjadi satu <div> utama.
    --}}
    <div
        ...
        <form action="{{ route('roles.update', $role->id) }}" method="POST">
            @csrf
            @method('PUT') {{-- Jangan lupa tambahkan method PUT untuk update --}}
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="name" id="name"
                        ...
                        {{-- Perbaikan: Tampilkan nama role yang sudah ada --}} value="{{ old('name', $role->name) }}" placeholder="Type product name"
                        required="">
                </div>
            </div>
