<x-layouts.app>
                ...
                <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm text-gray-500 dark:text-gray-400">
                            Milik:
                            <span
                                class="font-medium text-gray-700 dark:text-gray-300">{{ $parentIndicator->workResult->skpPlan->user->name ?? null }}</span>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <form method="POST" action="{{ route('work-cascading.skp-store') }}">
        @csrf
