<div class="flex items-center space-x-2">
    ...
    <a href="{{ route('performance-agreements.show', $skp->id) }}" class="group relative flex items-center">
        ...
        <span
            ...
            Show Detail Perjanjian Kerja
        </span>
    </a>

    <a href="{{ route('performance-agreements.edit', $skp->id) }}" class="group relative flex items-center">
    ...
    <form action="#" method="POST" class="inline"
        onsubmit="return confirm('Apakah Anda yakin ingin menghapus Perjanjian Kerja ini?');">
        @csrf
        @method('DELETE')
