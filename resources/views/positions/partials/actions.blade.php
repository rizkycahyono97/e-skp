<div class="flex items-center space-x-2">
    ...
    <a href="{{ route('positions.show', $position->id) }}" class="group relative flex items-center">
    ...
    <a href="{{ route('positions.edit', $position->id) }}" class="group relative flex items-center">
